(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('codemirror/index')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', 'codemirror/index'], factory) :
	(factory((global['ngx-codemirror'] = {}),global.ng.core,global.ng.common,global.index));
}(this, (function (exports,core,common,index) { 'use strict';

var CodeMirrorDirective = /** @class */ (function () {
    /**
     * @param {?} element
     */
    function CodeMirrorDirective(element) {
     ...
     * @return {?}
     */
    CodeMirrorDirective.prototype.ngOnInit = function () {
        var _this = this;
        this.editorRef = index.fromTextArea(this.element.nativeElement, this.config);
        this.editorRef.setValue(this.content);
        this.editorRef.on('change', function (cmInstance, event) { return _this.onChange.emit({ editorInstance: cmInstance, changes: event }); });
    };
    /**
     * @param {?} changes
     * @return {?}
     */
    CodeMirrorDirective.prototype.ngOnChanges = function (changes) {
        var _this = this;
        if (this.editorRef) {
            if (changes.content) {
                this.editorRef.setValue(this.content);
            ...
            if (changes.config) {
                Object.keys(this.config).map(function (k) { return _this.editorRef.setOption(k, _this.config[k]); });
            }
        }
    };
    /**
     * @return {?}
     */
    CodeMirrorDirective.prototype.getContent = function () {
     ...
     * @return {?}
     */
    CodeMirrorDirective.prototype.setOption = function (key, value) {
 ...
 * @nocollapse
 */
CodeMirrorDirective.ctorParameters = function () { return [
    ...
    (function (global, factory) {
        ...
        function off(emitter, type, f) {
            if (emitter.removeEventListener) {
                ...
                if (arr) {
                    var index$$1 = indexOf(arr, f);
                    if (index$$1 > -1) {
                        map$$1[type] = arr.slice(0, index$$1).concat(arr.slice(index$$1 + 1));
                    }
                }
            }
        }
        ...
        function viewCuttingPoint(cm, oldN, newN, dir) {
            var index$$1 = findViewIndex(cm, oldN), diff, view = cm.display.view;
            if (!sawCollapsedSpans || newN == cm.doc.first + cm.doc.size) {
                return { index: index$$1, lineN: newN };
            }
            ...
            if (n != oldN) {
                if (dir > 0) {
                    if (index$$1 == view.length - 1) {
                        return null;
                    }
                    diff = (n + view[index$$1].size) - oldN;
                    index$$1++;
                }
                else {
                    diff = n - oldN;
            ...
            while (visualLineNo(cm.doc, newN) != newN) {
                if (index$$1 == (dir < 0 ? 0 : view.length - 1)) {
                    return null;
                }
                newN += dir * view[index$$1 - (dir < 0 ? 1 : 0)].size;
                index$$1 += dir;
            }
            return { index: index$$1, lineN: newN };
        }
        ...
        Doc.prototype = createObj(BranchChunk.prototype, {
            ...
            indexFromPos: function (coords) {
                ...
                var index$$1 = coords.ch;
                if (coords.line < this.first || coords.ch < 0) {
                    return 0;
                }
                var sepSize = this.lineSeparator().length;
                this.iter(this.first, coords.line, function (line) {
                    index$$1 += line.text.length + sepSize;
                });
                return index$$1;
            },
        ...
        function fromTextArea$$1(textarea, options) {
        ...
        CodeMirror$1.fromTextArea = fromTextArea$$1;
...
exports.ɵa = CodeMirrorDirective;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ngx-codemirror.umd.js.map
